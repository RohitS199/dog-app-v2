...
const TOS_TEXT = `TERMS OF SERVICE — PupLog

Last Updated: ${LEGAL.TERMS_VERSION}

IMPORTANT: Please read these Terms of Service carefully before using PupLog.

1. EDUCATIONAL PURPOSE ONLY

PupLog provides EDUCATIONAL INFORMATION about dog health. It is NOT a substitute for professional veterinary advice, diagnosis, or treatment. PupLog does NOT establish a veterinarian-client-patient relationship (VCPR).

2. NOT VETERINARY MEDICINE

The urgency classifications provided by PupLog (Emergency, Urgent, Soon, Low Urgency) are educational guidance only. They are generated by artificial intelligence and may not account for all factors relevant to your dog's health. Always consult a licensed veterinarian for medical decisions.
...
PupLog uses artificial intelligence to analyze symptoms you describe. AI-generated content may contain errors or inaccuracies. The information provided should be used as a starting point for discussion with your veterinarian, not as a definitive medical assessment.
...
- Not rely solely on PupLog for medical decisions
- Seek professional veterinary care when needed
- Use the app only for dogs (not other animals or humans)

7. LIMITATION OF LIABILITY

PupLog and its creators shall not be liable for any damages arising from your use of or reliance on information provided by the app. This includes, without limitation, any harm to your pet resulting from decisions made based on app-generated content.

8. AGE REQUIREMENT

You must be at least 13 years old to use PupLog.
      ...
      <View style={styles.container}>
        ...
        <View style={styles.warningBanner}>
          ...
          <Text style={styles.warningText}>
            PupLog is an educational tool, not a substitute for veterinary care.
          </Text>
        </View>
